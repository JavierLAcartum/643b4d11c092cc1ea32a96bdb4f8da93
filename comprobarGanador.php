...
>>>>>>> origin/master
							...
							if(count($arrayIdPujas) >=2){
								?>
									<label style="position: absolute; left: 625px; top: 400px; font-family:'Segoe UI'; font-size: 13px; font-weight: bold; "> con la cantidad de <?php echo $arrayCantidadPujas[count($arrayIdPujas)-2]; ?>* </label> 
								<?php
								...
								?>
									<label style="position: absolute; left: 625px; top: 400px; font-family:'Segoe UI'; font-size: 13px; font-weight: bold; "> con la cantidad de <?php echo $arrayCantidadPujas[0]; ?>* </label> 
								<?php
                                $cantidadpujaganadora = $arrayCantidadPujas[0];
							}
						}
...
>>>>>>> origin/master
							...
							if(count($arrayIdPujas) >=2){
								?>
									<label style="position: absolute; left: 625px; top: 400px; font-family:'Segoe UI'; font-size: 13px; font-weight: bold; "> con la cantidad de <?php echo $arrayCantidadPujas[1]; ?>* </label> 
								<?php
								//Paga el segundo precio más bajo
