				...
				<!-- TABLA -->
					<table style="width:100%; padding: 30px; margin-top: 10px; font-family:'Segoe UI'; border: 1px solid black;">
					    <tr>
								...
								<td style="font-size: 12px; width: 135px; text-align: center;"><?php if(isset($imagenObjeto)){ echo "<img src='".$imagenObjeto."' width='100px' height='75px'>"; } else{ echo "*Sin imagen*";} ?></td>
